...
class _UserAddScreenState extends State<UserAddScreen> {
  ...
  final List<String> profileImages = [
    'assets/images/pexel1.png',
    'assets/images/pexel2.png'
  ];
  ...
  bool _isImageSelected(int index) {
    if (selectedImage == null) {
      return false;
    }
    return selectedImage == profileImages[index];
  }
  ...
  void _submit(BuildContext context) async {
    ...
    if (selectedImage == null) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Tolong Pilih foto anda')));
      return;
    }
